...
abundance_plot <-ggplot(abundances, aes(x=True_Abundance, y=Estimated_Abundance)) +
  ...
  stat_cor(method='spearman', label.x=0.6, label.y=0.4, col='navy', size=5, output.type='expression', 
